...
function initializePageBackground() {
  ...
  const palette = [
    ...
    { type: "solid", value: "#71BC20" },
    // { type: "gradient", stops: ["#ffa600", "#ffa600"] },
    // { type: "gradient", stops: ["#DE5A5A", "#DE5A5A"] },
    // { type: "gradient", stops: ["#275ED6", "#275ED6"] },
    // { type: "gradient", stops: ["#DFB1F1", "#DFB1F1"] },
    // { type: "gradient", stops: ["#71BC20", "#71BC20"] },
    // { type: "gradient", stops: ["#ff6600", "#ffa600"] },
    // { type: "gradient", stops: ["#eb3e3e", "#DE5A5A"] },
    // { type: "gradient", stops: ["#4b90d5", "#275ED6"] },
    // { type: "gradient", stops: ["#c594f3", "#DFB1F1"] },
    // { type: "gradient", stops: ["#96d483", "#71BC20"] },
